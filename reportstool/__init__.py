...
def get_db():
   return psycopg2.connect('host=localhost dbname=' + app.config['PGSQL_DB'] + ' user=' + app.config['PGSQL_USER'])

def get_mbdb():
   return psycopg2.connect('host=localhost dbname=' + app.config['PGSQL_MB_DB'] + ' user=' + app.config['PGSQL_MB_USER'])
